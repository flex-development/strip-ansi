...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/strip-ansi
   cd strip-ansi
   ```
...
```sh
https://github.com/flex-development/strip-ansi/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/strip-ansi/discussions/new?category=q-a
